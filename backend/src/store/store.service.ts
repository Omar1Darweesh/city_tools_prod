...
export class StoreService {
  ...
  async getProducts(params: { page?: number; limit?: number; categoryId?: number; subcategoryId?: number; subcategoryIds?: number[]; subcategoryName?: string; itemTypeId?: number; search?: string; sort?: string; isPopular?: boolean; isBestSale?: boolean; discounted?: boolean; badge?: string; brand?: string }) {
    const { page = 1, limit = 50, categoryId, subcategoryId, subcategoryIds, subcategoryName, itemTypeId, search, sort, isPopular, isBestSale, discounted, badge, brand } = params;
