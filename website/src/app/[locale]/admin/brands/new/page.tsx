    ...
    <div className="cf-root">
      <div className="cf-header">
        ...
        <div className="cf-title-row">
          ...
          <div>
            <h1 className="cf-title">{isRtl ? "إضافة ماركة جديدة" : "Add New Brand"}</h1>
            <p className="cf-sub">{isRtl ? "أضف ماركة جديدة للمتجر" : "Add a new brand to the store"}</p>
          </div>
        </div>
      </div>
        ...
        <div className="cf-actions">
          <button type="submit" disabled={saving} className="cf-save-btn" style={{ background: "#C0161B" }}>
            {saving ? (
              ...
              <><Save className="size-4" />{isRtl ? "حفظ الماركة" : "Save Brand"}</>
            )}
          </button>
